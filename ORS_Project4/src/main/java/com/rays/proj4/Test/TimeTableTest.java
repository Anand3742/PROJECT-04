...
//			bean.setId(30);
			...
			bean.setSubjectId(3);
			bean.setSubjectName("Managerial Economics");
			bean.setSemester("3rd");
			bean.setExamDate(sdf.parse("22/02/2022"));
			bean.setExamTime("08:00 AM to 11:00 AM");
			bean.setDescription("xyz");
			bean.setCreatedBy("dharyani2001@gmail.com");
			bean.setModifiedBy("dharyani2001@gmail.com");
